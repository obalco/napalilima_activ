          ...
          while($zaznam = mysql_fetch_assoc($res))
            {
              ...
              echo '<b>Nick: </b>'.$user.' | <b>Sťažnosť na: </b>'.$who.' | <b>Sťažnosť kedy: </b>'.$date.' | <b>Dátum odoslania: </b>'.$sys_date;  echo"nbsp; <a href='?req=like&id=".$id."'> LIKE </a>&nbsp; <a href='?req=dislike&id=".$id."'> DISLIKE </a>";
