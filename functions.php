...
function cenzura($text){
	...
	$slova=array();
	$znak= "";
	$vulgar = Array ("pica","piča", "kokot","kokotisko", "jebo","jeb","jebak","kurva","jebať","jebat","jebnutý","vyjebaný"); // Sem dopln slova ktore ta napadnu :D
...
function send_mail($mail,$token){
	    ...
	    $head="Content-Type: text/html;";
			...
			$mess='Práve ste pridali svoju prvú sťažnosť/komentár na stránka <a href="http://www.napalilima.sk>www.napalilima.sk</a>". Pre zobrazenie vašej sťažnosti/komentáru je potrebné aby ste klikli na tento odkaz. ';
			$mess.=$token;
